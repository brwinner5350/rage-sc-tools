...
public partial class Assembler : IDisposable
{
    ...
    private readonly SegmentBuilderRDR3 globalSegmentBuilder = new(GetSegmentAlignment(Segment.Global), isPaged: true),
    ...
    private SegmentBuilderRDR3 CurrentSegmentBuilder => CurrentSegment switch
    {
    ...
    public ScTools.GameFiles.RDR3.Script OutputScript { get; }
    ...
    private void ProcessInstruction(Parser.Instruction instruction)
    {
        ...
        if (!Enum.TryParse<OpcodeV16>(instruction.Opcode.Lexeme.Span, out var opcode))
        {
        ...
        {
            OpcodeV16.NOP => instEmitter.EmitNop(),
            OpcodeV16.IADD => instEmitter.EmitIAdd(),
            OpcodeV16.ISUB => instEmitter.EmitISub(),
            OpcodeV16.IMUL => instEmitter.EmitIMul(),
            OpcodeV16.IDIV => instEmitter.EmitIDiv(),
            OpcodeV16.IMOD => instEmitter.EmitIMod(),
            OpcodeV16.INOT => instEmitter.EmitINot(),
            OpcodeV16.INEG => instEmitter.EmitINeg(),
            OpcodeV16.IEQ => instEmitter.EmitIEq(),
            OpcodeV16.INE => instEmitter.EmitINe(),
            OpcodeV16.IGT => instEmitter.EmitIGt(),
            OpcodeV16.IGE => instEmitter.EmitIGe(),
            OpcodeV16.ILT => instEmitter.EmitILt(),
            OpcodeV16.ILE => instEmitter.EmitILe(),
            OpcodeV16.FADD => instEmitter.EmitFAdd(),
            OpcodeV16.FSUB => instEmitter.EmitFSub(),
            OpcodeV16.FMUL => instEmitter.EmitFMul(),
            OpcodeV16.FDIV => instEmitter.EmitFDiv(),
            OpcodeV16.FMOD => instEmitter.EmitFMod(),
            OpcodeV16.FNEG => instEmitter.EmitFNeg(),
            OpcodeV16.FEQ => instEmitter.EmitFEq(),
            OpcodeV16.FNE => instEmitter.EmitFNe(),
            OpcodeV16.FGT => instEmitter.EmitFGt(),
            OpcodeV16.FGE => instEmitter.EmitFGe(),
            OpcodeV16.FLT => instEmitter.EmitFLt(),
            OpcodeV16.FLE => instEmitter.EmitFLe(),
            OpcodeV16.VADD => instEmitter.EmitVAdd(),
            OpcodeV16.VSUB => instEmitter.EmitVSub(),
            OpcodeV16.VMUL => instEmitter.EmitVMul(),
            OpcodeV16.VDIV => instEmitter.EmitVDiv(),
            OpcodeV16.VNEG => instEmitter.EmitVNeg(),
            OpcodeV16.IAND => instEmitter.EmitIAnd(),
            OpcodeV16.IOR => instEmitter.EmitIOr(),
            OpcodeV16.IXOR => instEmitter.EmitIXor(),
            OpcodeV16.I2F => instEmitter.EmitI2F(),
            OpcodeV16.F2I => instEmitter.EmitF2I(),
            OpcodeV16.F2V => instEmitter.EmitF2V(),
            OpcodeV16.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0)),
            OpcodeV16.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0), u8(1)),
            OpcodeV16.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0), u8(1), u8(2)),
            OpcodeV16.PUSH_CONST_U32 => instEmitter.EmitPushConstU32(u32(0)),
            OpcodeV16.PUSH_CONST_F => instEmitter.EmitPushConstF(f32(0)),
            OpcodeV16.DUP => instEmitter.EmitDup(),
            OpcodeV16.DROP => instEmitter.EmitDrop(),
            OpcodeV16.NATIVE => instEmitter.EmitNative(u8(0), u8(1), u16(2)),
            OpcodeV16.ENTER => instEmitter.EmitEnter(u8(0), u16(1), GetFunctionName()),
            OpcodeV16.LEAVE => instEmitter.EmitLeave(u8(0), u8(1)),
            OpcodeV16.LOAD => instEmitter.EmitLoad(),
            OpcodeV16.STORE => instEmitter.EmitStore(),
            OpcodeV16.STORE_REV => instEmitter.EmitStoreRev(),
            OpcodeV16.LOAD_N => instEmitter.EmitLoadN(),
            OpcodeV16.STORE_N => instEmitter.EmitStoreN(),
            OpcodeV16.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0)),
            OpcodeV16.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0)),
            OpcodeV16.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0)),
            OpcodeV16.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0)),
            OpcodeV16.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0)),
            OpcodeV16.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0)),
            OpcodeV16.STATIC_U8 => instEmitter.EmitStaticU8(u8(0)),
            OpcodeV16.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0)),
            OpcodeV16.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0)),
            OpcodeV16.IADD_U8 => instEmitter.EmitIAddU8(u8(0)),
            OpcodeV16.IMUL_U8 => instEmitter.EmitIMulU8(u8(0)),
            OpcodeV16.IOFFSET => instEmitter.EmitIOffset(),
            OpcodeV16.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0)),
            OpcodeV16.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0)),
            OpcodeV16.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0)),
            OpcodeV16.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0)),
            OpcodeV16.IADD_S16 => instEmitter.EmitIAddS16(s16(0)),
            OpcodeV16.IMUL_S16 => instEmitter.EmitIMulS16(s16(0)),
            OpcodeV16.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0)),
            OpcodeV16.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0)),
            OpcodeV16.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0)),
            OpcodeV16.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0)),
            OpcodeV16.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0)),
            OpcodeV16.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0)),
            OpcodeV16.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0)),
            OpcodeV16.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0)),
            OpcodeV16.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0)),
            OpcodeV16.STATIC_U16 => instEmitter.EmitStaticU16(u16(0)),
            OpcodeV16.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0)),
            OpcodeV16.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0)),
            OpcodeV16.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0)),
            OpcodeV16.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0)),
            OpcodeV16.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0)),
            OpcodeV16.J => instEmitter.EmitJ(s16(0)),
            OpcodeV16.JZ => instEmitter.EmitJZ(s16(0)),
            OpcodeV16.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0)),
            OpcodeV16.INE_JZ => instEmitter.EmitINeJZ(s16(0)),
            OpcodeV16.IGT_JZ => instEmitter.EmitIGtJZ(s16(0)),
            OpcodeV16.IGE_JZ => instEmitter.EmitIGeJZ(s16(0)),
            OpcodeV16.ILT_JZ => instEmitter.EmitILtJZ(s16(0)),
            OpcodeV16.ILE_JZ => instEmitter.EmitILeJZ(s16(0)),
            OpcodeV16.CALL => instEmitter.EmitCall(u24(0)),
            OpcodeV16.STATIC_U24 => instEmitter.EmitStaticU24(u24(0)),
            OpcodeV16.STATIC_U24_LOAD => instEmitter.EmitStaticU24Load(u24(0)),
            OpcodeV16.STATIC_U24_STORE => instEmitter.EmitStaticU24Store(u24(0)),
            OpcodeV16.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0)),
            OpcodeV16.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0)),
            OpcodeV16.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0)),
            OpcodeV16.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0)),
            OpcodeV16.SWITCH => instEmitter.EmitSwitch(switchOps()),
            OpcodeV16.STRING => instEmitter.EmitString(),
            OpcodeV16.STRINGHASH => instEmitter.EmitStringHash(),
            OpcodeV16.TEXT_LABEL_ASSIGN_STRING => instEmitter.EmitTextLabelAssignString(u8(0)),
            OpcodeV16.TEXT_LABEL_ASSIGN_INT => instEmitter.EmitTextLabelAssignInt(u8(0)),
            OpcodeV16.TEXT_LABEL_APPEND_STRING => instEmitter.EmitTextLabelAppendString(u8(0)),
            OpcodeV16.TEXT_LABEL_APPEND_INT => instEmitter.EmitTextLabelAppendInt(u8(0)),
            OpcodeV16.TEXT_LABEL_COPY => instEmitter.EmitTextLabelCopy(),
            OpcodeV16.CATCH => instEmitter.EmitCatch(),
            OpcodeV16.THROW => instEmitter.EmitThrow(),
            OpcodeV16.CALLINDIRECT => instEmitter.EmitCallIndirect(),
            OpcodeV16.PUSH_CONST_M1 => instEmitter.EmitPushConstM1(),
            OpcodeV16.PUSH_CONST_0 => instEmitter.EmitPushConst0(),
            OpcodeV16.PUSH_CONST_1 => instEmitter.EmitPushConst1(),
            OpcodeV16.PUSH_CONST_2 => instEmitter.EmitPushConst2(),
            OpcodeV16.PUSH_CONST_3 => instEmitter.EmitPushConst3(),
            OpcodeV16.PUSH_CONST_4 => instEmitter.EmitPushConst4(),
            OpcodeV16.PUSH_CONST_5 => instEmitter.EmitPushConst5(),
            OpcodeV16.PUSH_CONST_6 => instEmitter.EmitPushConst6(),
            OpcodeV16.PUSH_CONST_7 => instEmitter.EmitPushConst7(),
            OpcodeV16.PUSH_CONST_FM1 => instEmitter.EmitPushConstFM1(),
            OpcodeV16.PUSH_CONST_F0 => instEmitter.EmitPushConstF0(),
            OpcodeV16.PUSH_CONST_F1 => instEmitter.EmitPushConstF1(),
            OpcodeV16.PUSH_CONST_F2 => instEmitter.EmitPushConstF2(),
            OpcodeV16.PUSH_CONST_F3 => instEmitter.EmitPushConstF3(),
            OpcodeV16.PUSH_CONST_F4 => instEmitter.EmitPushConstF4(),
            OpcodeV16.PUSH_CONST_F5 => instEmitter.EmitPushConstF5(),
            OpcodeV16.PUSH_CONST_F6 => instEmitter.EmitPushConstF6(),
            OpcodeV16.PUSH_CONST_F7 => instEmitter.EmitPushConstF7(),
    ...
    private void FixInstruction(InstructionReference instruction, ImmutableArray<Parser.InstructionOperand> operands)
    {
        ...
        _ = opcode switch
        {
            OpcodeV16.PUSH_CONST_U8 => instEmitter.EmitPushConstU8(u8(0, 1)),
            OpcodeV16.PUSH_CONST_U8_U8 => instEmitter.EmitPushConstU8U8(u8(0, 1), u8(1, 2)),
            OpcodeV16.PUSH_CONST_U8_U8_U8 => instEmitter.EmitPushConstU8U8U8(u8(0, 1), u8(1, 2), u8(2, 3)),
            OpcodeV16.PUSH_CONST_U32 => instEmitter.EmitPushConstU32(u32(0, 1)),
            OpcodeV16.NATIVE => instEmitter.EmitNative(u8NoCodeLabels(0), u8NoCodeLabels(1), u16NoCodeLabels(2)),
            OpcodeV16.ENTER => instEmitter.EmitEnter(u8(0, 1), u16(1, 2), opcode.GetEnterFunctionName(CollectionsMarshal.AsSpan(instBuffer.GetBytes(instruction)))),
            OpcodeV16.LEAVE => instEmitter.EmitLeave(u8(0, 1), u8(1, 1)),
            OpcodeV16.ARRAY_U8 => instEmitter.EmitArrayU8(u8(0, 1)),
            OpcodeV16.ARRAY_U8_LOAD => instEmitter.EmitArrayU8Load(u8(0, 1)),
            OpcodeV16.ARRAY_U8_STORE => instEmitter.EmitArrayU8Store(u8(0, 1)),
            OpcodeV16.LOCAL_U8 => instEmitter.EmitLocalU8(u8(0, 1)),
            OpcodeV16.LOCAL_U8_LOAD => instEmitter.EmitLocalU8Load(u8(0, 1)),
            OpcodeV16.LOCAL_U8_STORE => instEmitter.EmitLocalU8Store(u8(0, 1)),
            OpcodeV16.STATIC_U8 => instEmitter.EmitStaticU8(u8(0, 1)),
            OpcodeV16.STATIC_U8_LOAD => instEmitter.EmitStaticU8Load(u8(0, 1)),
            OpcodeV16.STATIC_U8_STORE => instEmitter.EmitStaticU8Store(u8(0, 1)),
            OpcodeV16.IADD_U8 => instEmitter.EmitIAddU8(u8(0, 1)),
            OpcodeV16.IMUL_U8 => instEmitter.EmitIMulU8(u8(0, 1)),
            OpcodeV16.IOFFSET_U8 => instEmitter.EmitIOffsetU8(u8(0, 1)),
            OpcodeV16.IOFFSET_U8_LOAD => instEmitter.EmitIOffsetU8Load(u8(0, 1)),
            OpcodeV16.IOFFSET_U8_STORE => instEmitter.EmitIOffsetU8Store(u8(0, 1)),
            OpcodeV16.PUSH_CONST_S16 => instEmitter.EmitPushConstS16(s16(0, 1)),
            OpcodeV16.IADD_S16 => instEmitter.EmitIAddS16(s16(0, 1)),
            OpcodeV16.IMUL_S16 => instEmitter.EmitIMulS16(s16(0, 1)),
            OpcodeV16.IOFFSET_S16 => instEmitter.EmitIOffsetS16(s16(0, 1)),
            OpcodeV16.IOFFSET_S16_LOAD => instEmitter.EmitIOffsetS16Load(s16(0, 1)),
            OpcodeV16.IOFFSET_S16_STORE => instEmitter.EmitIOffsetS16Store(s16(0, 1)),
            OpcodeV16.ARRAY_U16 => instEmitter.EmitArrayU16(u16(0, 1)),
            OpcodeV16.ARRAY_U16_LOAD => instEmitter.EmitArrayU16Load(u16(0, 1)),
            OpcodeV16.ARRAY_U16_STORE => instEmitter.EmitArrayU16Store(u16(0, 1)),
            OpcodeV16.LOCAL_U16 => instEmitter.EmitLocalU16(u16(0, 1)),
            OpcodeV16.LOCAL_U16_LOAD => instEmitter.EmitLocalU16Load(u16(0, 1)),
            OpcodeV16.LOCAL_U16_STORE => instEmitter.EmitLocalU16Store(u16(0, 1)),
            OpcodeV16.STATIC_U16 => instEmitter.EmitStaticU16(u16(0, 1)),
            OpcodeV16.STATIC_U16_LOAD => instEmitter.EmitStaticU16Load(u16(0, 1)),
            OpcodeV16.STATIC_U16_STORE => instEmitter.EmitStaticU16Store(u16(0, 1)),
            OpcodeV16.GLOBAL_U16 => instEmitter.EmitGlobalU16(u16(0, 1)),
            OpcodeV16.GLOBAL_U16_LOAD => instEmitter.EmitGlobalU16Load(u16(0, 1)),
            OpcodeV16.GLOBAL_U16_STORE => instEmitter.EmitGlobalU16Store(u16(0, 1)),
            OpcodeV16.J => instEmitter.EmitJ(s16(0, 1)),
            OpcodeV16.JZ => instEmitter.EmitJZ(s16(0, 1)),
            OpcodeV16.IEQ_JZ => instEmitter.EmitIEqJZ(s16(0, 1)),
            OpcodeV16.INE_JZ => instEmitter.EmitINeJZ(s16(0, 1)),
            OpcodeV16.IGT_JZ => instEmitter.EmitIGtJZ(s16(0, 1)),
            OpcodeV16.IGE_JZ => instEmitter.EmitIGeJZ(s16(0, 1)),
            OpcodeV16.ILT_JZ => instEmitter.EmitILtJZ(s16(0, 1)),
            OpcodeV16.ILE_JZ => instEmitter.EmitILeJZ(s16(0, 1)),
            OpcodeV16.CALL => instEmitter.EmitCall(u24(0, 1)),
            OpcodeV16.STATIC_U24 => instEmitter.EmitStaticU24(u24(0, 1)),
            OpcodeV16.STATIC_U24_LOAD => instEmitter.EmitStaticU24Load(u24(0, 1)),
            OpcodeV16.STATIC_U24_STORE => instEmitter.EmitStaticU24Store(u24(0, 1)),
            OpcodeV16.GLOBAL_U24 => instEmitter.EmitGlobalU24(u24(0, 1)),
            OpcodeV16.GLOBAL_U24_LOAD => instEmitter.EmitGlobalU24Load(u24(0, 1)),
            OpcodeV16.GLOBAL_U24_STORE => instEmitter.EmitGlobalU24Store(u24(0, 1)),
            OpcodeV16.PUSH_CONST_U24 => instEmitter.EmitPushConstU24(u24(0, 1)),
            OpcodeV16.SWITCH => instEmitter.EmitSwitch(switchOps()),
            OpcodeV16.TEXT_LABEL_ASSIGN_STRING => instEmitter.EmitTextLabelAssignString(u8(0, 1)),
            OpcodeV16.TEXT_LABEL_ASSIGN_INT => instEmitter.EmitTextLabelAssignInt(u8(0, 1)),
            OpcodeV16.TEXT_LABEL_APPEND_STRING => instEmitter.EmitTextLabelAppendString(u8(0, 1)),
            OpcodeV16.TEXT_LABEL_APPEND_INT => instEmitter.EmitTextLabelAppendInt(u8(0, 1)),
    ...
    private static (ScriptValue64[] Statics, uint StaticsCount, uint ArgsCount) SegmentToStaticsArray(SegmentBuilderRDR3 staticSegment, SegmentBuilderRDR3 argSegment)
    {
    ...
    private static (ulong[] Natives, uint NativesCount) SegmentToNativesArray(SegmentBuilderRDR3 segment, uint codeLength)
    {
    ...
    public readonly struct Instruction
    {
        ...
        public OpcodeV16 Opcode { get; }
        public int Offset { get; }
        public int Length { get; }

        public Instruction(Parser.Instruction instruction, OpcodeV16 opcode, int offset, int length)
        {
    ...
    private sealed class CodeBuilder
    {
        ...
        public void Opcode(OpcodeV16 v) => U8((byte)v);
        ...
        public (int InstructionOffset, int InstructionLength) Flush()
        {
            ...
            OpcodeV16 opcode = (OpcodeV16)buffer[0];
