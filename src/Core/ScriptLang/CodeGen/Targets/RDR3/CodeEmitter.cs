...
public sealed partial class CodeEmitter : ICodeEmitter
{
    ...
    public StringsTableRDR3 Strings { get; } = new();
    ...
    private ScriptPageTable<ScriptValue64>? GetGlobalSegment(ScriptDeclaration script, out int blockIndex)
    {
        ...
        var globalSegment = new ScTools.ScriptAssembly.SegmentBuilderRDR3(Assembler.GetSegmentAlignment(Assembler.Segment.Global), isPaged: true);
    ...
    private IScript FinalizeScript(ScriptDeclaration script)
    {
        ...
        return new ScTools.GameFiles.RDR3.Script
        {
            Name = script.Name,
